...
res = requests.post('http://127.0.0.1:5000/api/insert_new_event/', json={'event_id':2, 'user_id':2, 'title':'test', 'desc':'test', 'datetime':'test', 'tags':'test,test2', 'lat':45, 'lon':45, 'agegroup':'0-80', 'imgs':'test.png'})
print(res.text)
